    ...
    >
      ...
      justify-between items-center w-full"
        >
          ...
          flex-1 ss:leading-[100px] leading-[75px]"
          >
            The Next
          ...
          ease-in-out hover:[transform:rotate(360deg)]
          group`}>
            <GetStarted />
          </div>
        </div>
      ...
      my-10 md-0 relative`}>
        ...
        w-[80%] h-[80%] bottom-40 white__gradient`}>
        </div>
        <div className={`absolute z-[0] right-20
        w-[50%] h-[50%] bottom-20 blue__gradient`}>
        </div>
      </div>

      <div className={`ss:hidden flex justify-center
        items-center transition-transform duration-500
        ease-in-out hover:[transform:rotate(360deg)]
        group`}>
          <GetStarted />
      </div>
